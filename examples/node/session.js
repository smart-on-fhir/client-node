 ...
 * provide session support to our node-patients-list example. In real-life
 * scenarios you would probably use some framework with built-in (or plugged-in)
 * session support.
...
function getSessionIdFromCookie(request) {
    let cookie = String(request.headers.cookie || "").trim()
        .split(/\s*;\s*/)
